  ...
  constructor(options) {
    ...
    super("AsciiEffect", fragmentShader, {
      ...
      uniforms: new Map([
        ...
        ["targetFPS", new Uniform(postfx.targetFPS || 1)],

        ["jitterIntensity", new Uniform(postfx.jitterIntensity || 0.05)],

        ["jitterSpeed", new Uniform(postfx.jitterSpeed || 2)],
        ...
        ["aberrationStrength", new Uniform(postfx.aberrationStrength || 0.0031)],

        ["noiseIntensity", new Uniform(postfx.noiseIntensity || 0.1)],
        ...
        ["waveFrequency", new Uniform(postfx.waveFrequency || 1)],

        ["waveSpeed", new Uniform(postfx.waveSpeed || 0.3)],
